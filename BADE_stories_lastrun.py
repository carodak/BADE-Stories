...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/macbookpro/Documents/dossier_douglas/Katie/cognitive tasks/new/official/bade-stories/BADE_Stories_lastrun.py',
...
slider1_pr = visual.Slider(win=win, name='slider1_pr',
    startValue=None, size=(1.4, 0.03), pos=(0, 0.01), units=None,
    labels=['0%','100%'], ticks=(0,100), granularity=0,
    style=['rating'], styleTweaks=(), opacity=1,
    labelColor='Gray', markerColor='Black', lineColor='White', colorSpace='rgb',
...
slider2_pr = visual.Slider(win=win, name='slider2_pr',
    startValue=None, size=(1.4, 0.03), pos=(0, -0.122), units=None,
...
slider3_pr = visual.Slider(win=win, name='slider3_pr',
    startValue=None, size=(1.4, 0.03), pos=(0, -0.25), units=None,
    labels=["0%", "100%"], ticks=(0, 1), granularity=0,
    style=['rating'], styleTweaks=(), opacity=1,
    labelColor='Gray', markerColor='Black', lineColor='White', colorSpace='rgb',
    font='HelveticaBold', labelHeight=0.03,
...
slider4_pr = visual.Slider(win=win, name='slider4_pr',
    startValue=None, size=(1.4, 0.03), pos=(0, -0.38), units=None,
    labels=["0%", "100%"], ticks=(0, 1), granularity=0,
    style=['rating'], styleTweaks=(), opacity=1,
    labelColor='Gray', markerColor='Black', lineColor='White', colorSpace='rgb',
    font='HelveticaBold', labelHeight=0.03,
